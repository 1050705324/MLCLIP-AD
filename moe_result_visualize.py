...
def main():
    ...
    parser.add_argument('--save_path_moe_adapter', type=str, default='./ckpt/fire/moe')
    ...
    #load parameter
    checkpoint = torch.load(os.path.join(f'{args.save_path_moe_adapter}', f'{args.obj}_moe.pth'))
